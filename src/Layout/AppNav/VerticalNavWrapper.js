  ...
  render() {
    return (
      <Fragment>
        ...
        <Link onClick={this.toggleMobileSidebar} to="/dashboards/blog">
          <h4>
            <button className="gradientBtn" style={{ width: "100%" }}>
              <span
                className="metismenu-item"
        ...
        <Link onClick={this.toggleMobileSidebar} to="/dashboards/videos">
          <h4>
            <button className="gradientBtn" style={{ width: "100%" }}>
              <span
                className="metismenu-item"
        ...
        <Link onClick={this.toggleMobileSidebar} to="/dashboards/about">
          <h4>
            <button className="gradientBtn" style={{ width: "100%" }}>
              <span
                className="metismenu-item"
